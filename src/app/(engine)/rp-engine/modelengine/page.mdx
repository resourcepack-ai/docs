export const metadata = {
  ...
  description:
    "Drop a folder of Model Engine blueprints into RP Engine and they load — the bone names already mean the same thing.",
};
...
**The bone names already mean the same thing**, because they are Model Engine's
...
<Callout type="note" title="What a .bbmodel cannot carry">
  ...
  Minecraft model format rather than of the reader, and Model Engine works
