...
RP Engine hooks into PlaceholderAPI so anything that reads a placeholder can
ask it questions — what a player is holding, whether they hold a bundle, how
much content this server has — and print the answer.
