...
The rebuild waits five seconds and covers everybody who arrived meanwhile, and
only players whose pack is actually out of date are sent a new one. Off is for
a server that would rather choose the moment — a big pack, a busy lobby — and
`/rp reload` still bakes whatever has arrived since.
