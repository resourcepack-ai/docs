...
- **Resolved impacts are available to addons.** The official `vehicle-status`
  ...
  rupture a wheel mounting immediately. Loose parts retain incoming momentum
  and tumble under gravity. Scrape decals persist on the collision shell,
  so the hitbox should closely fit the model; they are hidden after part loss.
