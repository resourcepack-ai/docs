...
| Command | What it does | Permission |
| --- | --- | --- |
| `/rp edit model <id>` | Open the 3D model an item wears | `rpengine.edit` |
| `/rp edit texture <id>` | Open the item's own sprite in a pixel editor | `rpengine.edit` |
| `/rp edit vehicle <id>` | Open a vehicle's seats, handling and effects | `rpengine.edit` |
