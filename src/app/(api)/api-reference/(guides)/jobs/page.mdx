...
<Callout type="tip" title="How often to poll">
  ...
  seconds; a model takes minutes, so back off rather than hammering — there's
  nothing to gain, and polling does spend a key's read budget. Two seconds a job
  fits four jobs in flight; see [Rate limits](/api-reference/rate-limits).
</Callout>
